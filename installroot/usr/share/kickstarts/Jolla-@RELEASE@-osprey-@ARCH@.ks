# DisplayName: Jolla osprey/@ARCH@ (release) 1
...
repo --name=adaptation0-osprey-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-motorola-osprey/@ARCH@/
...
%packages
@Jolla Configuration osprey
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/osprey
